...
namespace Ui {
class NetworkProviderPlugin;
}

class NetworkProviderPlugin : public Engine::IPlugin
{
    Q_OBJECT
...
private:
    ...
    Ui::NetworkProviderPlugin *m_ui;

public:
    explicit NetworkProviderPlugin();
    ~NetworkProviderPlugin();
